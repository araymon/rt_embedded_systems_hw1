/*! \mainpage HW1 by Ayodeji Raymond
 *
 * \section intro_sec Reader Writer Problem
 *
 ...
 * 
 *
 * \section issue_sec Synchronization Issue
 *
...
value.
* \section solution_sec My Solution
...
*
*
\section test_sec Test Cases Rationale
...
'AccessTest' in ./src/test_cases.cpp. These test show that writers block when they
...
My priority rights tests are labeled 'PriorityTest' in ./src/test_cases.cpp.
...
This string is then compared to a predicted outcome in ./src/test_cases.cpp.
